...
var FeatureService_1 = require("../services/FeatureService");
...
router.route(path + "/:accountid")
    ...
    return __generator(this, function (_a) {
        if (req.params['accountid']) {
            features = FeatureService_1.GetFeatureVotesWithAccountId(req.params['accountid']);
            res.send(features);
        }
        return [2 /*return*/];
    });
...
exports.FeatureController = router;
