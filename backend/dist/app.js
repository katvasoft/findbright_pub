...
var AccountRoutes_1 = require("./routes/AccountRoutes");
...
typeorm_1.createConnection().then(function (connection) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        app.use('/api', AccountRoutes_1.AccountController);
        app.use('/api', UserRoutes_1.UserController);
        app.use('/api', SetupRoutes_1.SetupController);
